  ...
  return (
    <section id="preturi" className="py-16 lg:py-24">
      <div className="text-center mb-16">
        <p className="text-sm font-semibold italic text-black leading-relaxed opacity-70 text-center">PREȚURI DE START + OFERTE CUSTOM</p>
        <h2 className="text-4xl lg:text-5xl font-bold my-4">
      ...
      <div className="flex justify-center mb-12">
        <div className="bg-black rounded-lg p-1 flex relative">
          <button 
            ...
            className={`px-6 py-2 font-semibold transition-all duration-300 relative z-10 ${
              activeTab === 'website' 
                ? 'text-black' 
                : 'text-white'
            }`}
      ...
      {/* Pricing Cards */}
      <div className="bg-[#fbfbfb] rounded-[30px] p-[3px] w-[1000px] flex gap-4">
        {/* Website Card */}
        <div className="p-[34px] h-full flex flex-col justify-between pb-5">
          <div className="w-full flex flex-col gap-[18px] mb-[44px]">
            <div className="flex flex-col items-center gap-2.5">
              <div className="w-full flex items-center gap-1.5">
                ...
                <h3 className="text-black text-2xl font-bold">Website</h3>
              </div>
            ...
            <div className="flex items-center justify-between h-[58px] bg-white gap-2 p-3 rounded-xl">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-black font-semibold">Mentenanță & suport 30€/lună</span>
              </div>
              <div 
            ...
            {/* Testimonial */}
            <div className="bg-white rounded-2xl p-5 h-[168px] flex flex-col justify-between">
              <div className="flex flex-row w-full justify-between items-center">
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-10 h-10 bg-yellow-400 rounded-full flex items-center justify-center">
                    <Image src="/images/pricing/andrei.png" alt="Testimonial Avatar" width={40} height={40} />
                  </div>
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Antreprenor</p>
                  </div>
                </div>
        ...
        {/* Website Custom Card */}
        <div className="bg-black rounded-2xl p-[34px] h-full flex flex-col justify-between pb-5 relative text-white" style={{boxShadow: '0 8px 32px rgba(0, 0, 0, 0.3)'}}>
          <div className="w-full flex flex-col gap-[18px] mb-[44px]">
            <div className="flex flex-col items-center gap-2.5">
              <div className="w-full flex items-center gap-1.5">
                ...
                <h3 className="text-white text-2xl font-bold">Website Custom</h3>
              </div>
              <div className='w-full'>
            ...
            <div className="flex items-center justify-between h-[58px] bg-[#303030] gap-2 p-3 rounded-xl">
              <div className="flex items-center gap-2">
                <svg width="19" height="20" viewBox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M16.11 3.4175L10.94 0.4275C9.95 -0.1425 8.4 -0.1425 7.41 0.4275L2.19 3.4375C0.12 4.8375 0 5.0475 0 7.2775V12.7075C0 14.9375 0.12 15.1575 2.23 16.5775L7.4 19.5675C7.9 19.8575 8.54 19.9975 9.17 19.9975C9.8 19.9975 10.44 19.8575 10.93 19.5675L16.15 16.5575C18.22 15.1575 18.34 14.9475 18.34 12.7175V7.2775C18.34 5.0475 18.22 4.8375 16.11 3.4175ZM9.17 13.2475C7.38 13.2475 5.92 11.7875 5.92 9.9975C5.92 8.2075 7.38 6.7475 9.17 6.7475C10.96 6.7475 12.42 8.2075 12.42 9.9975C12.42 11.7875 10.96 13.2475 9.17 13.2475Z" fill="white"/>
                </svg>

                <span className="text-sm text-white font-semibold">Mentenanță & suport ?€/lună</span>
              </div>
              <div 
                className={`w-12 h-6 rounded-full relative cursor-pointer transition-colors ${
              ...
              <div className="flex flex-row w-full justify-between items-center">
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-10 h-10 bg-blue-400 rounded-full flex items-center justify-center">
                    <Image src="/images/pricing/eduard.png" alt="Testimonial Avatar" width={40} height={40} />
                  </div>
                  <div>
                    <div className="flex items-center gap-1">
                      <span className="font-semibold text-black">Eduard C.</span>
                      <CheckBadge />
                    </div>
                    <p className="text-sm text-[#6c6c6c]">Fondator startup tech</p>
                  </div>
                </div>
                <div className="flex items-center gap-1 mb-2">
                  {[...Array(5)].map((_, i) => (
            ...
            <button className="w-full bg-white text-black py-3 px-4 rounded-lg font-medium flex items-center justify-center gap-2">
