...
export default function PricingSection() {
  ...
  return (
    <section id="preturi" className="py-8 lg:py-12">
      <div className="text-center mb-8">
        <p className="text-sm font-semibold italic text-black leading-relaxed opacity-70 text-center px-4">PREȚURI DE START + OFERTE CUSTOM</p>
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold my-4">
          <span className="bg-[linear-gradient(to_right,#588AFF_0%,#C2E0FF_60%)] bg-clip-text text-transparent">PREȚURI</span>
        </h2>
      </div>
      ...
      <div className="flex justify-center mb-6 px-4">
        <div className="bg-black rounded-lg p-1 flex relative">
          <button 
            ...
            className={`px-4 sm:px-6 py-2 font-semibold transition-all duration-300 relative z-10 text-sm sm:text-base ${
              activeTab === 'website' 
                ? 'text-black' 
                : 'text-white'
            }`}
      ...
      {/* Pricing Cards */}
      <div className="bg-[#fbfbfb] rounded-[30px] p-[3px] w-full max-w-[1000px] mx-auto flex flex-col lg:flex-row gap-4">
        {/* Website Card */}
        <div className="p-4 sm:p-6 lg:p-[34px] h-full flex flex-col justify-between pb-5 bg-white rounded-2xl lg:rounded-none">
          <div className="w-full flex flex-col gap-4 sm:gap-[18px] mb-6 sm:mb-[44px]">
            <div className="flex flex-col items-center gap-2.5">
              <div className="w-full flex items-center gap-1.5">
                ...
                <h3 className="text-black text-xl sm:text-2xl font-bold">Website</h3>
              </div>
              <div className='w-full'>
                <p className="text-sm text-gray-400 text-left w-full">Preț de start pentru site-uri profesionale</p>
              </div>
            </div>
            
            <div className="flex items-end gap-0.5">
              <p className="text-sm text-gray-400 mb-1">Preț de la</p>
              <div className="text-3xl sm:text-4xl font-bold text-gray-900">400€</div>
            </div>
            ...
            <div className="flex items-center justify-between h-auto sm:h-[58px] bg-white gap-2 p-3 rounded-xl">
              <div className="flex items-center gap-2 flex-1">
                ...
                <span className="text-xs sm:text-sm text-black font-semibold">Mentenanță & suport 30€/lună</span>
              </div>
              <div 
                ...
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <div className="flex items-center gap-1">
                      <span className="font-semibold text-gray-900 text-sm sm:text-base">Andrei M.</span>
                      <CheckBadge className="w-4 h-4 sm:w-auto sm:h-auto" />

                    </div>
                    <p className="text-xs sm:text-sm text-gray-500">Antreprenor</p>
                  </div>
                </div>
          ...
          <div className="flex flex-col gap-2 sm:gap-2.5 w-full h-full">
            {[
              ...
              <div key={index} className="flex items-center gap-2">
                ...
                <span className="text-xs sm:text-sm text-black leading-tight">{feature}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* Website Custom Card */}
        <div className="bg-black rounded-2xl p-4 sm:p-6 lg:p-[34px] h-full flex flex-col justify-between pb-5 relative text-white" style={{boxShadow: '0 8px 32px rgba(0, 0, 0, 0.3)'}}>
          <div className="w-full flex flex-col gap-4 sm:gap-[18px] mb-6 sm:mb-[44px]">
            <div className="flex flex-col items-center gap-2.5">
              <div className="w-full flex items-center gap-1.5">
                ...
                <h3 className="text-white text-xl sm:text-2xl font-bold">Website Custom</h3>
              </div>
              <div className='w-full'>
            ...
            <div className="flex items-center justify-between h-auto sm:h-[58px] bg-[#303030] gap-2 p-3 rounded-xl">
              <div className="flex items-center gap-2 flex-1">
                ...
                <span className="text-xs sm:text-sm text-white font-semibold">Mentenanță & suport ?€/lună</span>
              </div>
              <div 
                className={`w-12 h-6 rounded-full relative cursor-pointer transition-colors flex-shrink-0 ${
            ...
            <div className="bg-white rounded-2xl p-4 sm:p-5 h-auto sm:h-[168px] flex flex-col justify-between">
              <div className="flex flex-row w-full justify-between items-start sm:items-center">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <div className="flex items-center gap-1">
                      <span className="font-semibold text-black text-sm sm:text-base">Eduard C.</span>
                      <CheckBadge className="w-4 h-4 sm:w-auto sm:h-auto" />
                    </div>
                    <p className="text-xs sm:text-sm text-[#6c6c6c]">Fondator startup tech</p>
                  </div>
                </div>
                <div className="flex items-center gap-1 mb-2">
                  {[...Array(5)].map((_, i) => (
          ...
          <div className="flex flex-col gap-2 sm:gap-2.5 w-full h-full">
            {[
              ...
              <div key={`feature_${index}`} className="flex items-center gap-2">
                ...
                <span className="text-xs sm:text-sm text-white leading-tight">{feature}</span>
              </div>
            ))}
          </div>
        </div>
