  ...
  return (
    <section id="cum-lucram" className="py-16 lg:py-24">
      <div className="text-center">
        <p className="text-sm font-semibold italic text-[#171E29] leading-relaxed opacity-70 mx-auto text-center">SIMPLU, RAPID ȘI TRANSPARENT</p>
        <h2 className="text-4xl lg:text-5xl font-bold mb-4">
          <span className="text-black font-extrabold text-[42px]">CUM</span>
          <span className="bg-[linear-gradient(to_right,#588AFF_15%,#C2E0FF_90%)] bg-clip-text text-transparent font-extrabold text-[42px]"> LUCRĂM?</span>
        </h2>
      </div>
      
      <div className="flex justify-center items-center gap-x-10 my-10">

        <div className="w-[306px] h-[422px] flex flex-col gap-2">
          <div className="bg-white h-[280xp] rounded-[10px] flex items-center justify-center">
            <Image src="/images/how-we-work/1.png" alt="How We Work" className="w-full" width={574} height={561} />
          </div>
        ...
        <div className="w-[306px] h-[422px] flex flex-col gap-2">
          <div className="bg-white h-[280xp] rounded-[10px] flex items-center justify-center">
            <Image src="/images/how-we-work/2.png" alt="How We Work" className="w-full" width={574} height={561} />
          </div>
          <div className="flex flex-col justify-between items-center gap-2">
        ...
        <div className="w-[306px] h-[422px] flex flex-col gap-2">
          <div className="bg-white h-[280xp] rounded-[10px] flex items-center justify-center">
            <Image src="/images/how-we-work/3.png" alt="How We Work" className="w-full" width={574} height={561} />
          </div>
          <div className="flex flex-col justify-between items-center gap-2">
